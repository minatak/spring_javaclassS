...
<div>
	<p>
		...
		<a href="${ctp}/study/kakao/kakaoEx2" class="btn btn-primary">MY DB에 저장된 지명 검색</a>
		<a href="${ctp}/study/kakao/kakaoEx3" class="btn btn-secondary">Kakao DB에 저장된 키워드 검색</a>
