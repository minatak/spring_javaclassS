...
<div class="container">
  ...
  <div class="text-center">
  	<c:if test="${idCheck == 'OK'}">
  		<font color="red"><b>${mid}는 사용 가능한 아이디입니다 :)</b></font>
  	</c:if>
  	<c:if test="${idCheck == 'NO'}">
  		<font color="red"><b>${mid}는 이미 사용중인 아이디입니다.<br/>다른 아이디를 입력해주세요.</b></font><br/>
  		 <form name="childForm" method="get" action="${ctp}/dbtetst/dbtestWindow">
        <p>아이디 : 
